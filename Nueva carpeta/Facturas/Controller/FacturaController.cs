...
namespace Facturas.Controller
{
    public class FacturaController
    {
        ...
        public static string PATH = Settings.Default.RutaDirectorio+ Settings.Default.RutaLOG;
        ...
        {
            RutaData = Settings.Default.RutaDirectorio+ Settings.Default.DirectorioDATA + oRucEmi + "-" + oDocType + "-" + oSerie + "-" + oFolioNum + ".json";
            RutaXml = Settings.Default.RutaDirectorio + Settings.Default.DirectorioFIRMA + oRucEmi + "-" + oDocType + "-" + oSerie + "-" + oFolioNum + ".xml";
            RutaPdf = Settings.Default.RutaDirectorio + Settings.Default.DirectorioREPO + oRucEmi + "-" + oDocType + "-" + oSerie + "-" + oFolioNum + ".pdf";
            RutaCdr = Settings.Default.RutaDirectorio + Settings.Default.DirectorioRPTA + "R" + oRucEmi + "-" + oDocType + "-" + oSerie + "-" + oFolioNum + ".zip";
            RutaXmlCdr = Settings.Default.RutaDirectorio + Settings.Default.DirectorioRPTA + "R" + "-" + oRucEmi + "-" + oDocType + "-" + oSerie + "-" + oFolioNum + ".xml";
        }
        ...
        public async Task<bool> GetXmlAsync()
        {
            ...
            var client = new RestClient(Settings.Default.httpBandeja+Settings.Default.httpFirma);
        ...
        {
            string oJson = FacturaController.CreaJsonDoc(oRucEmi, oDocType, oSerie + "-" + oFolioNum);
            var client = new RestClient(Settings.Default.httpBandeja + Settings.Default.httpEnvio);
            var solicitud = new RestRequest(Method.POST);
            solicitud.AddHeader("Content-Type", "application/json");
            solicitud.AddParameter("application/json", oJson, ParameterType.RequestBody);
            IRestResponse response = await client.ExecuteAsync(solicitud);
        ...
        {
            var client = new RestClient(Settings.Default.httpBandeja + Settings.Default.httpActualizar);
            var solicitud = new RestRequest(Method.POST);
            solicitud.AddHeader("Content-Type", "application/json");
